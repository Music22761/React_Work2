    ...
    <>
      <div className="con1">
        <div className="divCol">
          <div>
            <h1>{DataStars.star_movies[index - 1].name}</h1>
          </div>
          <div className="divRow" style={{ height: "400px" }}>
            <div style={{ width: "300px", overflow: "hidden" }}>
              <img
                ...
                src={DataStars.star_movies[index - 1].image}
                alt=""
              />
            </div>
            <div style={{ width: "800px", overflow: "hidden" }}>
              <iframe
                ...
                src={DataStars.star_movies[index - 1].video}
          ...
          <div>
            <p>{DataStars.star_movies[index - 1].description}</p>
          </div>
          <div className="divRow" style={{ width: "100%" }}>
            ...
            >
              <h4>Born {DataStars.star_movies[index - 1].born}</h4>
              <ButtonGroup
                variant="contained"
